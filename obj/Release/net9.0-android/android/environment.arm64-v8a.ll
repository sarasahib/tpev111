...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x1b07e99eec33350d, ; from name: MauiApp1ATM
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	}, ; 82
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2d29d0935da672ef, ; from name: libaot-MauiApp1ATM.so
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x54b39a13497db9f7, ; from name: libaot-MauiApp1ATM
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6611f47cf9628ea8, ; from name: aot-MauiApp1ATM
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x70dc3c20576ea2a3, ; from name: aot-MauiApp1ATM.dll.so
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x737c2ee55fa81def, ; from name: libaot-MauiApp1ATM.dll.so
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xadc76c36bb5098eb, ; from name: aot-MauiApp1ATM.so
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xae30c7e9f058c72f, ; from name: MauiApp1ATM.dll.so
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc320fd76df5b6db8, ; from name: MauiApp1ATM.so
		i64 u0x737c2ee55fa81def, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiApp1ATM.dll.so
		ptr null; void* handle
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-MauiApp1ATM.dll.so\00", align 1
